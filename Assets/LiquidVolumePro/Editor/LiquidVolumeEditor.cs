...
namespace LiquidVolumeFX {
    ...
    public class LiquidVolumeEditor : Editor {
        ...
        SerializedProperty doubleSidedBias, rotationLevelBias, backDepthBias;
        SerializedProperty level, levelMultipler, liquidColor1, liquidColor2, liquidScale1, liquidScale2, alpha, emissionColor;
        ...
        bool shaderFeatureScattering, shaderFeatureSmoke, shaderFeatureBubbles, shaderFeatureFPRenderTextures, shaderFeatureOrtho;
        ...
        public override void OnInspectorGUI() {
            ...
            if ((detail.intValue == (int)DETAIL.Simple && !shaders[0]) || (detail.intValue == (int)DETAIL.Default && !shaders[1]) || (detail.intValue == (int)DETAIL.DefaultNoFlask && !shaders[1]) ||
            ...
            if (detailed != DETAIL.DefaultNoFlask && detailed != DETAIL.MultipleNoFlask) {
                EditorGUILayout.Separator();
